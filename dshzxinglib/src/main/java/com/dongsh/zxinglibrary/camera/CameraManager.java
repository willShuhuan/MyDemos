...
package com.dongsh.zxinglibrary.camera;
...
import com.dongsh.zxinglibrary.android.CaptureActivityHandler;
import com.dongsh.zxinglibrary.bean.ZxingConfig;
import com.dongsh.zxinglibrary.common.Constant;

import com.dongsh.zxinglibrary.decode.MyPlanarYUVLuminanceSource;
...
//    }
     ...
     */
    public MyPlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
        ...
        if (config.isFullScreenScan()) {
            return new MyPlanarYUVLuminanceSource(data, width, height, 0,
                    0, width, height, false);
        } else {
            return new MyPlanarYUVLuminanceSource(data, width, height, rect.left,
