...
import com.dongsh.zxinglibrary.decode.DecodeImgCallback;
import com.dongsh.zxinglibrary.decode.DecodeImgThread;
import com.dongsh.zxinglibrary.decode.ImageUtil;
import com.dongsh.zxinglibrary.view.ViewfinderView;
...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    public void handleDecode(Result rawResult, Bitmap barcode) {
        ...
        bundle.putString(Constant.CODED_CONTENT, rawResult.getText());
        bundle.putParcelable(Constant.CODED_BITMAP, barcode);
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        barcode.compress(Bitmap.CompressFormat.PNG, 100, baos);
        byte[] bitmapByte = baos.toByteArray();
        bundle.putByteArray(Constant.CODED_BITMAP, bitmapByte);
